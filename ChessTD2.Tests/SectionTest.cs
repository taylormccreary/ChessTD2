...
namespace ChessTD2.Tests
{
    ...
    public class SectionTest
    {
        ...
        public void calculateScoreAndOpponents()
        {
            ...
            Assert.AreEqual(101, players2.First().opponents.First().PlayerID);
            Assert.AreEqual(103, players2.First().opponents.ElementAt(1).PlayerID);
            Assert.AreEqual(102, players2.First().opponents.ElementAt(2).PlayerID);
            Assert.AreEqual(101, players2.First().opponents.ElementAt(3).PlayerID);
        }
    ...
    public class SectionPlayerForPairing
    {
        ...
        public ICollection<Player> Opponents { get; set; }
